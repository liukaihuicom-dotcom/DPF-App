...
export default function AccountBasicScreen() {
  ...
  return (
    <Screen align="center" back title={t('accountDetails.menuBasicInfo')}>
      <Card compact>
          ...
          {section.rows.map((row, rowIndex) => (
            <View
              ...
              style={StyleSheet.flatten([
                styles.infoRow,
                rowIndex < section.rows.length - 1 && { borderBottomColor: palette.lineSoft, borderBottomWidth: 1 },
              ])}>
