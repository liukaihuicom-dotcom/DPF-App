...
description: "Use for variables, design tokens, component libraries, icon systems, pattern registries, code mapping, design-system QA, release governance, and design-system engineering."
---
