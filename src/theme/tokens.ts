...
export const layout = {
  ...
  fundActionIconBoxSize: size.iconFrame.md,
  fundActionIconSize: size.iconFrameGlyph.md,
  screenPaddingX: spacing.lg,
  screenGap: spacing.md,
  screenBottomPadding: spacing.xxl,
  headerIconButtonSize: size.iconFrame.lg,
  headerIconSize: size.iconFrameGlyph.lg,
...
export const titleTypography = {
  ...
  pageCompact: typography.sheetTitle,
