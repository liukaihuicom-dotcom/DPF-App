...
export const themeColors: Record<ResolvedThemeMode, ThemeColors> = {
  darkTerminal: {
    ...
    iconBg: {
      active: alpha(teal['400'], '18'),
      danger: alpha('#FF6B7E', '18'),
      info: alpha('#74A8FF', '18'),
      inverse: alpha(white, '12'),
      marketDown: alpha('#24C985', '18'),
      marketUp: alpha('#FF5A68', '18'),
      neutral: '#2A2A2A',
      subtle: '#2C2C2C',
      success: alpha('#24C985', '18'),
      warning: alpha('#F4B000', '18'),
    },
    market: {
  ...
  lightBroker: {
    ...
    iconBg: {
      active: alpha(teal['600'], '12'),
      danger: alpha(colorPrimitives.red['700'], '12'),
      info: alpha(colorPrimitives.blue['600'], '12'),
      inverse: alpha(white, '12'),
      marketDown: alpha(colorPrimitives.green['600'], '12'),
      marketUp: alpha(colorPrimitives.red['700'], '12'),
      neutral: '#ECEEF2',
      subtle: '#EEF0F3',
      success: alpha(colorPrimitives.green['600'], '12'),
      warning: alpha(colorPrimitives.amber['700'], '12'),
    },
    market: {
    ...
    overlay: {
      ...
      success: overlays(colorPrimitives.green['600']),
  ...
  midnightBlue: {
    ...
    iconBg: {
      active: alpha(teal['400'], '18'),
      danger: alpha('#FF7391', '18'),
      info: alpha('#7AB8FF', '18'),
      inverse: alpha(white, '12'),
      marketDown: alpha('#24C985', '18'),
      marketUp: alpha('#FF6478', '18'),
      neutral: '#2C2C2C',
      subtle: '#303030',
      success: alpha('#24C985', '18'),
      warning: alpha('#F4B000', '18'),
