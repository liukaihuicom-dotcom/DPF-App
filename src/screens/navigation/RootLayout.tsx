...
function RootLayoutNav() {
  ...
  useEffect(() => {
    ...
    const isPublicRoute =
      ...
      pathname === '/launch' ||
      pathname === '/discover' ||
      pathname === '/discover-layout' ||
      pathname.startsWith('/discover-entry/') ||
      pathname === '/auth' ||
    ...
    if (authStatus === 'signedIn' && pinStatus === 'set' && pinGateStatus === 'locked' && !isPublicRoute && pathname !== '/auth/pin-setup') {
          ...
          <BottomSheetProvider>
            <AppViewport>
              <Stack
                ...
                <Stack.Screen name="funding/index" />
                <Stack.Screen name="funding/deposit" />
                <Stack.Screen name="funding/withdrawal" />
                <Stack.Screen name="funding/transfer" />
                <Stack.Screen name="funding/transactions/index" />
                <Stack.Screen name="funding/transactions/[id]" />
                <Stack.Screen name="appearance" />
                <Stack.Screen name="settings/index" />
                <Stack.Screen name="settings/security-log" />
                <Stack.Screen name="discover-entry/[id]" />
                <Stack.Screen
