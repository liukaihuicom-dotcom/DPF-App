    ...
    <AuthShell
      ...
      <View style={StyleSheet.flatten([styles.heroPanel, { backgroundColor: colors.surface.panel }])}>
        <View style={styles.heroRow}>
          <View style={StyleSheet.flatten([styles.heroIcon, { backgroundColor: colors.text.primary }])}>
      ...
      <View style={styles.choiceGrid}>
        {quickChoices.map(([icon, title, hint]) => (
          <NativePressable
            ...
            <AppIconFrame name={icon as AppIconName} size={spacing.xxl} iconSize={15} />
            <AppText variant="body">{title}</AppText>
            <AppText numberOfLines={3} tone="muted" variant="caption">
              {hint}
            </AppText>
      ...
      <View style={StyleSheet.flatten([styles.notice, { backgroundColor: colors.surface.subtle }])}>
