...
export const discoverEntryDefinitions: DiscoverEntryDefinition[] = [
  ...
  },
  {
    ...
    route: '/discover-entry/education',
    status: 'placeholder',
  ...
  },
  {
    ...
    moduleId: 'challenge',
    roles: ['trader', 'partner'],
    route: '/discover-entry/challenge',
    status: 'placeholder',
  ...
  },
  {
    ...
    moduleId: 'rewards',
    roles: ['trader', 'partner'],
    route: '/discover-entry/rewards',
    status: 'placeholder',
    subtitle: { 'en-US': 'Practice rewards, badges, and growth missions.', 'zh-CN': '练习奖励、成长徽章和任务。' },
  ...
  },
  {
    ...
    moduleId: 'community',
    roles: ['trader', 'partner'],
    route: '/discover-entry/community',
    status: 'placeholder',
    subtitle: { 'en-US': 'Signal posts, trade reviews, and paper-trader community flow.', 'zh-CN': '信号帖、交易复盘和练习交易社区流程。' },
  ...
  },
  {
    ...
    status: 'demo',
    subtitle: {
      'en-US': 'Referral links, commission program, performance overview, and Partner network.',
      'id-ID': 'Tautan referral, program komisi, ringkasan performa, dan jaringan Partner.',
      'zh-CN': '推荐链接、佣金计划、表现概览和 Partner 网络。',
    },
