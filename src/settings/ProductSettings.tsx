...
type ProductSettings = {
  ...
  profileNicknameLastChangedAt?: string;
  ...
  setProfileNicknameLastChangedAt: (lastChangedAt?: string) => void;
...
export function ProductSettingsProvider({ children }: PropsWithChildren) {
  ...
  const [pinStatus, setPinStatus] = useState<PinStatus>(
    isPinStatus(stored.pinStatus) ? stored.pinStatus : 'unset',
  );
  ...
  const [profileNicknameLastChangedAt, setProfileNicknameLastChangedAt] = useState(readOptionalString(stored.profileNicknameLastChangedAt));
  ...
  const resetProductSettings = () => {
    ...
    setProfileNicknameLastChangedAt(undefined);
    setProfileNickname('');
    setRole('trader');
