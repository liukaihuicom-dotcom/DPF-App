...
| Border | none; cards must not render visible border color |
| Radius | `radius.md` |
...
- Card separation should come from surface contrast, spacing, and optional highlight shadow, not from `borderColor`.
