...
| radius.md | 12 | Runtime card default |
| radius.lg | 20 | Friendly card and sheet surfaces |
| radius.xl | 32 | Large pill controls |
| radius.full | 999 | Circular icons and pill buttons |

## Rules

- Repeated cards should stay at 12 to 20 px radius.
