...
description: Project production Skill for building shippable UI pages and screens. Use before implementing App, H5, Web, Admin, prototype, or page UI from Page Contracts, design-system tokens, component manifests, pattern registries, state matrices, interactions, responsive rules, visual QA, accessibility QA, or developer handoff.
---
